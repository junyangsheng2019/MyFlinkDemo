...
public class TestDocument {
    ...
    private static String idnex="movie_index";
    @Test
    public void testGet() throws IOException {
//        1.构建请求
        GetRequest getRequest = new GetRequest(idnex, "RxgogXQBJbvoGEpb6N8V");
//        -------------------------可选参数start-------------------------
...
//        indexRequest.source(jsonString, XContentType.JSON);
        ...
        jsonMap.put("user","fengxiao");
        jsonMap.put("postDate","2018-07-18");
...
//        indexRequest.source(jsonMap);
        ...
        builder.startObject();
        {
            ...
            builder.field("message","trying out es4");
        }
        builder.endObject();
